  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption: "flex justify-center pt-1 relative items-center rdp-dropdown",
        ...
        cell: "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-range-start)]:rounded-l-md",
